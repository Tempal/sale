...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/pms/**", "anon");//hello添加
		filterChainDefinitionMap.put("/cms/**", "anon");//hello添加
		filterChainDefinitionMap.put("/hello/**", "anon");//hello添加
		filterChainDefinitionMap.put("/test/**", "anon");//hello添加
		//cas验证登录
