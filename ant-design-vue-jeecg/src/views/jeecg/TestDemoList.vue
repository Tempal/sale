  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/test2/testDemo/list",
          delete: "/test2/testDemo/delete",
          deleteBatch: "/test2/testDemo/deleteBatch",
          exportXlsUrl: "test2/testDemo/exportXls",
          importExcelUrl: "test2/testDemo/importExcel",
       },
    }
  },
  computed: {
